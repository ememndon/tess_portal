...
Drop screenshots and the demo-video poster here, using these exact filenames so
the main README picks them up automatically:

| Filename | Screen | What to show |
|---|---|---|
| `screenshot-discover.png` | Discover | The scored job list with "Sponsor confirmed" badges, filters, and pagination — the hero shot |
...
(your actual email address, real recruiter messages, private contact details).
